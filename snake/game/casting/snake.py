...
class Snake(Actor):
    ...
    def __init__(self, num, color):    #I changed the constructor, if you need to call Snake(1), and Snake(2)
        ...
        if num == 1:
            ...
            self._prepare_body(350,350) #gives diferent initial positions snake(2)
    ...
    def move_next(self):
        ...
        self.grow_tail(1) #grows tail by one segment on each move
    ...
    def _prepare_body(self, x, y):
        ...
        for i in range(constants.SNAKE_LENGTH):
            ...
            text = "8" if i == 0 else "#"
            color = constants.YELLOW if i == 0 else self._snake_color
